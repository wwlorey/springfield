...
>
> Springfield's role — orchestrating Claude Code through Ralph-style iterative loops, scoping work into prompts, and coordinating multi-stage pipelines — is now handled **directly inside Claude Code** via a skills-based system in [dotfiles repo](https://github.com/wwlorey/dotfiles) under `.agents/skills/`.
