...
| [springfield](specs/springfield.md) | `crates/springfield/` | proven | CLI entry point — scaffolding, prompt delivery, loop orchestration, recovery, and daemon lifecycle |
| [test-harness](specs/test-harness.md) | `crates/springfield/tests/` | proven | Integration test harness — shared fixtures, concurrency control, and mock infrastructure for springfield CLI tests |
